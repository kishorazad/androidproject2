package com.example.brij.longitudeandlatitude;
...
import com.example.brij.longitudeandlatitude.GPS_Service;
...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean runtime_permissions() {
        if(Build.VERSION.SDK_INT>=23 && ContextCompat.checkSelfPermission(this, Manifest.permission
                .ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(this, String.valueOf(true))){
